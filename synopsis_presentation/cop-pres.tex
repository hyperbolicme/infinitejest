...
\frame[label=FREXAMPLE3]{
  ...
  \begin{tabular}{c|c}
      ...
      \end{tabular}\\
    &
    \includegraphics[scale=0.2]{../img/1_infinite_loop.png}\\%{a1.pdf}\\
...
\frame[label=FR_EX_IMAGE]{
  ...
  %% Frames 2,3,4
  {
    \begin{tabular}{cc}
      ...
      \only<3-4>{
        \includegraphics[scale=0.2]{../img/2_infinite_loop_BTWF.png}%{a2.pdf}
      } & 
...
%   }
  ...
  %% Frames 5,6,7
  {
    \begin{tabular}{cc}
      ...
      \only<4>
      {  \includegraphics[scale=0.1]{../img/3_infinite_loop.png}&} %{a3.pdf}
    \end{tabular}
  }
}
...
\frame[label=FR_EX_TERM]{ 
  ...
  \only<3>{
    \includegraphics[scale=\termimgscale]{../img/1_infinite_loop.png} %\tnote{../img/1_infinite_loop.png} 
    \begin{block}{}
  ...
  \only<4>{
    \includegraphics[scale=\termimgscale]{../img/2_infinite_loop_BTWF.png} %\tnote{../img/2_infinite_loop_BTWF.png} 
    \begin{block}{}
  ...
  \only<5,6>{
    \includegraphics[scale=0.2]{../img/3_infinite_loop.png} %\tnote{../img/3_infinite_loop.png} 
    \begin{block}{}
