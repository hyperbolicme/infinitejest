...
\begin{definition}[\emph{Binary matrix}]
...
\begin{definition}[\emph{set system}]
\end{definition}


\begin{definition}[\emph{\Cop}]
  \tnote[important]{define cop here. refer to it in chap 2 or
    duplicate it using slash def }
  \begin{enumerate}
  \item \Cop
  \item Strong \cop
  \item \Cop order or \cop permutation
  \item \Cop for set systems\tnote{see mcc04}
  \end{enumerate}
\end{definition}

\figcopmatrix
\tnote[important]{have a figure for set systems also}

\begin{definition}[\emph{\Crop}]
  \tnote[important]{define circ1 here. refer to it in chap 2 or
    duplicate it using slash def }
\end{definition}


\begin{definition}[\emph{Graph, Tree}]
  
\end{definition}

\begin{definition}[\emph{Maximal clique}]
...
\cite{at72}\tnote{check the real meaning of AT FREE. }. The first linear
