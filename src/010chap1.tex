...
\begin{definition}[Graph, Tree, Path, Graph Isomorphism]
  \label{def:graphtree}
  \begin{enumerate}
    \hangindent \defindent
...
% Recognizing clique graphs of directed edge path 
% graphs
% UV DuallyChordal Swarcter and Bornstein [10] 
% DV DuallyDV Prisner and Swarcter [8] 
% RDV DuallyRDV Prisner and Swarcter [8] 
% UE 
% DE DuallyDE This paper 
% RDE = RDV DuallyRDV Prisner and Swarcter [8] 
