...
\tnote{set context: COP - generalization - TPL - no opt. just 2 or 3
  sentences. use the space that the illustration does.}
% \tnote{testing 1 2 3...}
...
allocation is also shown\tnote[TH]{in
  Fig~ref::fig:streetmappathpeople}. How this is algorithmically
...
%   \caption{\figtabsize Individual allocation of apartments to students in
%     {\residenceblock} that meets the requirements stated before.}
%   \label{fig:streetmappathpeople}
% \end{figure}
