...
{\TTT}. \tnote[TH]{put bib entries for these works!} A student
...
\begin{figure}[t] %[htbp]
  ...
  \begin{tabular}[h]{l|lcccl}
    ...
    \end{tabular}
  \end{tabular}
  \caption{Matrices with and without COP. $M_1$ has COP because by
...
\tnote[TH]{cite:lb62 - interval graphs are at-free chordal}

\cite{at72} showed that a matrix that does not have COP have
certain substructures that prevent it from having
COP. Tucker classified these forbidden substructures into five classes of
submatrices. This result is presented in the context of convex
bipartite graphs which \cite{at72} proved to be
AT-free\tnote[TH]{ check this up. give details. - doms'}. Convex bipartite
graph have vertex incidence adjacency matrices is
