...
%\begin{definition}[Set systems and hypergraphs] 
  ...
  set system $\F$ denoted by $\supt{\cF}$ is the union of all the sets
  in $\F$; $supp(\F) = \bigcup_{S \in \F}S$. For the purposes of this
...
%\begin{definition}[Partially ordered sets]
  ...
  partial order on $X$.  $X_m \in X$ is a maximal upper bound of $X$
  if $\nexists X_q \in X$ such that $X_m \preccurlyeq X_q$.  A maximal
  upper bound on $X$ is denoted by $mub(X)$.
  %represents an element in $X$ which is a maximal upper bound on $X$.
%\end{definition}
...
without further qualification, it is intended that $i \in I$. 
...
feasibility of a tree path labeling.  
We focus on the question of generalizing the notion of an
