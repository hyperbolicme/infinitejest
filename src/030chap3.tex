...
\begin{figure}[htb]
  ...
  \caption[\figtabsize Hypergraphs and set systems]{\figtabsize
    ...
    property anymore due to the addition of hyperedge $\{x_1,
    x_4\}$. }
...
\begin{proof}\thesisspacing
  ...
  \item {\em Invariant} IV
    ...
    \tnote[dire]{Due to the condition in line~\ref{ln:3waycheck}, this invariant is
...
\tnote[dire]{ inthis section we run through the algorithm in the
