...
PQ trees. \temptext{dom chapter 2 pg 40 Variations of PQTrees first
  para - summarize.}  
...
Thus the idea of \cop naturally maps to set sytems as well\endnote{As
  seen in Section~\ref{sec:courseschedule}} as
...
\tnote{What does n89 say? download paper from cornell website.}
