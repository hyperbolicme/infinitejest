...
\chapter[Consecutive-ones Property -- A Survey]{Consecutive-ones Property -- A Survey of Important Results}
\label{ch:copsurvey}
...
the result {\sc hmpv00}\tnote{cite hmpv00} \tnote{in footnote put the
  theorem 2.7 - dom pg 43} \cite{d08phd} which demonstrates how such a
...
%       {}
    ...
    \parbox[t]{\colwidth}
    {
      ...
      \temptext{PQR tree def. }\tnote[pressing]{in terms of theory}
    }
    \\\hline
...
\begin{observation} 
  ...
  that will place $b$ in between $a$ and $c$. \tnote{also cite the
...
theorem. \tnote{all refrences to ``following''/abov theorem must be
