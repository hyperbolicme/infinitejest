...
submatrices, \PQtree, \PQRtree and ICPIA. \tnote[dire]{mention the section
  that compares pqr and gen pq tree} 
...
\tnote[dire]{narrative is abrupt from here. add some explanation for the
...
%       {}
    ...
    \tnote[dire]{give def of P Q R nodes}
    \\\lasthline
...
\tnote[dire]{ abrupt: Add a section closing para. does this method (above)
...
substructures (See Section~\ref{sec:tucker} for detailed
  ...
  \COP) is of prime importance and we saw an algorithm for it in
  Section~\ref{sec:forbiddensubalgo}. 
}
...
these substructures in the input. \tnote[dire]{Fill neg results on
