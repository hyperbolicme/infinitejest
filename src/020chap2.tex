...
$\cF$. \tnote{define substitutio decomp.} This is later used to define
...
permutation of $U$\endnote{$\emptyset$ is considered consecutive by
  convention.}.
...
work with for reasons that will become apparent.\tnote{VAGUe!}
