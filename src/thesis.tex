...
%% Drafting libraries %%
%
\usepackage[color,notcite,notref]{showkeys}   % To show keys used - useful in
                               % drafts. 
...
\xclearpage
\pagestyle{fancy}%headings}   % For running headers.
\fancyhf{}%            % Clears headers
\fancyhead[LE,RO]{\scriptsize \slshape \rightmark} %{\slshape \rightmark}
\fancyhead[LO,RE]{\scriptsize \slshape \leftmark} %{\slshape \leftmark}
