...
\def \mythesissubmissionmonth {\MakeUppercase {December 2011}}
...
\tnote{ The main themes of the thesis that must not be left out:\\
  ...
  ||graph isomorphism|| by canonization cite:kklv10\\
...
\chapter{Consecutive-Ones property - Important Results from Literature}
