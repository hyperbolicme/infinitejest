...
\def \mythesissubmissiondate {13 January 2012}
...
% Main body Chapters
%
\include{figuresandtables} % Load floats. No rendering.
...
%
\begin{singlespace}
  \addcontentsline{toc}{chapter}{REFERENCES \tnote[minor]{(i)make names
