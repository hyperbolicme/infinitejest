...
%% Drafting libraries %%
%
\usepackage[color,notcite,notref,final]{showkeys}   % To show keys used - useful in
                               % drafts. 
...
%\includeonly{010chap1, 020chap2}         % DEBUG ONLY 
\includeonly{030chap3,050appa}         % DEBUG ONLY 
%\includeonly{0031ded,0032quote}         % DEBUG ONLY
%\includeonly{020chap2}         % DEBUG ONLY 
%\includeonly{040chap4,biblio}         % DEBUG ONLY 
%\includeonly{_tempscrap}         % DEBUG ONLY 
%\includeonly{010chap1}         % DEBUG ONLY 

%\excludeonly{0032quote,0031ded,002ack}         % DEBUG ONLY 

\def \mythesissubmissiondate {\today}
\def \mythesissubmissionmonth {\MakeUppercase {February 2012}}
...
%\fancyhf{}%            % Clears headers -- ALSO REMOVES PAGE
                        % NUMBERS. IF USED, PUT PG# IN FOOTER.
